...
class PhoneBook
{
  ...
  static void Main()
  {
    ...
    {
      Console.WriteLine("Would you like to lookup a number in yout phone book? ['Y' for yes, 'Enter' for no]");
  ...
  static void AddContact()
  {
    ...
    {
      Console.WriteLine("That person is already in your phonebook. There number is " + phoneNumbers[name]);
    }
    else
    {
  ...
  static void LookUpContact()
  {
    ...
    {
      Console.WriteLine("This person is not in your phone book.");
    }
    Main();
  }
}
